...
<html>
    <head>
        ...
        <link href="${ctx}/assets/global/plugins/bootstrap-daterangepicker/daterangepicker.min.css" rel="stylesheet" type="text/css" />
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
        ...
        <div class="page-header navbar navbar-fixed-top">
            ...
            <div class="page-header-inner ">
                ...
                <div class="page-logo">
                    <a href="index.html">
                        <img src="${ctx}/assets/layouts/layout/img/logo.png" alt="logo" class="logo-default" /> </a>
                                ...
                                <li>
                                    <ul class="dropdown-menu-list scroller" style="height: 275px;" data-handle-color="#637283">
                                        <li>
                                            <a href="#">
                                                <span class="photo">
                                                    <img src="${ctx}/assets/layouts/layout3/img/avatar2.jpg" class="img-circle" alt=""> </span>
                                                <span class="subject">
                                        ...
                                        <li>
                                            <a href="#">
                                                <span class="photo">
                                                    <img src="${ctx}/assets/layouts/layout3/img/avatar3.jpg" class="img-circle" alt=""> </span>
                                                <span class="subject">
                                        ...
                                        <li>
                                            <a href="#">
                                                <span class="photo">
                                                    <img src="${ctx}/assets/layouts/layout3/img/avatar1.jpg" class="img-circle" alt=""> </span>
                                                <span class="subject">
                ...
                <div class="page-sidebar navbar-collapse collapse">
                    ...
                    <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                        ...
                        <li class="nav-item  ">
                            ...
                            <ul class="sub-menu">
                                <li class="nav-item  ">
                                    <a href="info.htm" class="nav-link ">
                            ...
                            <div class="portlet light bordered">
                                ...
                                <div class="portlet-body">
                                    <div id="site_statistics_loading">
                                        <img src="${ctx}/assets/global/img/loading.gif" alt="loading" /> </div>
                            ...
                            <div class="portlet light bordered">
                                ...
                                <div class="portlet-body" id="chats">
                                    <div class="scroller" style="height: 525px;" data-always-visible="1" data-rail-visible1="1">
                                        <ul class="chats">
                                            <li class="out">
                                                <img class="avatar" alt="" src="${ctx}/assets/layouts/layout/img/avatar2.jpg" />
                                                <div class="message">
                                                    <span class="arrow"> </span>
                                            ...
                                            <li class="in">
                                                <img class="avatar" alt="" src="${ctx}/assets/layouts/layout/img/avatar1.jpg" />
                                                <div class="message">
                                                    <span class="arrow"> </span>
                                            ...
                                            <li class="out">
                                                <img class="avatar" alt="" src="${ctx}/assets/layouts/layout/img/avatar3.jpg" />
                                                <div class="message">
                                                    <span class="arrow"> </span>
                            ...
                            <div class="page-quick-sidebar-chat-users" data-rail-color="#ddd" data-wrapper-class="page-quick-sidebar-list">
                                ...
                                <ul class="media-list list-items">
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="${ctx}/assets/layouts/layout/img/avatar3.jpg" alt="...">
                                    ...
                                    <li class="media">
                                        <img class="media-object" src="${ctx}/assets/layouts/layout/img/avatar1.jpg" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="${ctx}/assets/layouts/layout/img/avatar4.jpg" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <img class="media-object" src="${ctx}/assets/layouts/layout/img/avatar2.jpg" alt="...">
                                        <div class="media-body">
                                ...
                                <ul class="media-list list-items">
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="${ctx}/assets/layouts/layout/img/avatar6.jpg" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="${ctx}/assets/layouts/layout/img/avatar7.jpg" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <img class="media-object" src="${ctx}/assets/layouts/layout/img/avatar8.jpg" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="${ctx}/assets/layouts/layout/img/avatar9.jpg" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <img class="media-object" src="${ctx}/assets/layouts/layout/img/avatar10.jpg" alt="...">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="${ctx}/assets/layouts/layout/img/avatar11.jpg" alt="...">
                                        <div class="media-body">
...
<![endif]-->
        ...
        <!-- END CORE PLUGINS -->
        <!-- BEGIN PAGE LEVEL PLUGINS -->
        <script src="${ctx}/assets/global/plugins/moment.min.js" type="text/javascript"></script>
        <script src="${ctx}/assets/global/plugins/bootstrap-daterangepicker/daterangepicker.min.js" type="text/javascript"></script>
        ...
        <script src="${ctx}/assets/global/plugins/amcharts/amcharts/amcharts.js" type="text/javascript"></script>
        <script src="${ctx}/assets/global/plugins/amcharts/amcharts/serial.js" type="text/javascript"></script>
        <script src="${ctx}/assets/global/plugins/amcharts/amcharts/pie.js" type="text/javascript"></script>
        <script src="${ctx}/assets/global/plugins/amcharts/amcharts/radar.js" type="text/javascript"></script>
        <script src="${ctx}/assets/global/plugins/amcharts/amcharts/themes/light.js" type="text/javascript"></script>
        <script src="${ctx}/assets/global/plugins/amcharts/amcharts/themes/patterns.js" type="text/javascript"></script>
        <script src="${ctx}/assets/global/plugins/amcharts/amcharts/themes/chalk.js" type="text/javascript"></script>
        <script src="${ctx}/assets/global/plugins/amcharts/ammap/ammap.js" type="text/javascript"></script>
        <script src="${ctx}/assets/global/plugins/amcharts/ammap/maps/js/worldLow.js" type="text/javascript"></script>
        <script src="${ctx}/assets/global/plugins/amcharts/amstockcharts/amstock.js" type="text/javascript"></script>
        ...
        <script src="${ctx}/assets/pages/scripts/dashboard.min.js" type="text/javascript"></script>
